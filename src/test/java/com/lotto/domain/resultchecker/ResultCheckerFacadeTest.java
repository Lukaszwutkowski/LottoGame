...
public class ResultCheckerFacadeTest {
    ...
    public void it_should_generate_all_players_with_correct_message(){
        ...
        when(numberReceiverFacade.retrieveAllTicketsByNextDrawDate()).thenReturn(List.of(TicketDto.builder()
                ...
                TicketDto.builder()
                        .hash("002")
                        .numbers(Set.of(1, 2, 9, 12, 14, 16))
                        .drawDate(drawDate)
                        .build(),
                TicketDto.builder()
                        .hash("003")
                        .numbers(Set.of(12, 22, 13, 14, 15, 16))
                        .drawDate(drawDate).build()));
    ...
    @Test
    public void it_should_generate_fail_message_when_winning_numbers_equal_null(){
        //given
        when(winningNumbersGeneratorFacade.generateWinningNumbers()).thenReturn(WinningNumbersDto.builder()
                .winningNumbers(null)
                .build());
    ...
    @Test
    public void it_should_generate_fail_message_when_winning_numbers_is_empty(){
        //given
        when(winningNumbersGeneratorFacade.generateWinningNumbers()).thenReturn(WinningNumbersDto.builder()
